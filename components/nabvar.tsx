                ...
                <Dialog>
                    ...
                    <SheetContent side="left">
                        ...
                        <div className="flex flex-col space-y-3 mt-[1rem] z-[99]">
                            ...
                            <DialogClose asChild>
                                <Link href="/analysis">
                                    <Button variant="outline" className="w-full">Analysis</Button>
                                </Link>
                            </DialogClose>
                            <DialogClose asChild>
                                <Link href="/projects">
                                    <Button variant="outline" className="w-full">Project</Button>
                                </Link>
                            </DialogClose>
                            <ModeToggle />
                        </div>
                ...
                <NavigationMenu>
                    <NavigationMenuList className="max-[825px]:hidden ">
                        <Link href="/" className="pl-2">
                            <h1 className="font-bold">fikc.</h1>
                        </Link>
                    </NavigationMenuList>
                </NavigationMenu>
